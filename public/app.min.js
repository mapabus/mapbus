class BusMapApp {
  ...
  showRouteForVehicle(routeId, vehicleId, color) {
    ...
    // Fallback: traži bilo koji shape za ovu rutu
    console.log('Fallback: tražim shapes za rutu', routeId);
    let matchingShapes = [];
    for (let shapeKey in this.shapesData) {
    ...
    console.log('Pronađeni shapes:', matchingShapes);
    
    if (matchingShapes.length > 0) {
      this.drawRoute(matchingShapes[0], color);
    } else {
